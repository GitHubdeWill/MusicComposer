...
public class Driver
{
	...
	public static void main(String[] args)
	{
		...
		int[][] progression_2 = {
				...
				{0,1,1,1,1,1,0,2,0,6,2,5 ,2,6,1,2}//Scale Type
//				{0,9,5,7},
//				{0,1,0,0},
//				{0,9,5,7}
		};
		...
		int[][] progression_5 = {
				...
				{0,0,5 ,1,1,1,7,2}//Scale Type
		};
		int[][] progression_4 = {
				{0,7,2,9,4,11,5,5},//Root Note
				{2,3,4,4,4,9 ,3,2},//Chord
				{0,2,1,1,1,5 ,6,0}//Scale Type
		};
		int[][] progression_3 = {
		...
		int[][][] progs = new int[][][]{progression_2, progression_3, progression_4
			,progression_5};
		
		Composer.compose(mBuilder, progs[Composer.getRanItemFromArray(new int[]{0,1,2,3})], Composer.MAJOR_SCALES, Composer.SIMPLE_RYTHMN, Composer.SIMPLE_DRYTHMN, 12,10,16);
